...
lab
#> <scr_classing> target "default" | opened 2026-09-04 13:05 by analyst | 37 variables | 0 proposals: 0 accepted, 0 discarded
...
p_breaks
#> <scr_classing_proposal> P001 vl_score_01 | breaks = c(40, 55, 70) | 2026-09-04 13:05
...
p_split
#> <scr_classing_proposal> P003 vl_score_01 | split = c(1, 28.36) | 2026-09-04 13:05
#>                         optimal     manual      delta
#>   n_bins                      7          8          1
...
p_groups <- scr_classing_propose(lab, "ds_regiao",
                                 groups = list(south = c("BA", "RS"),
                                               north = c("SP", "RJ", "MG")))
p_groups
#> <scr_classing_proposal> P004 ds_regiao | groups = list(south = c("BA", "RS"), north = c("SP", "RJ", "MG")) | 2026-09-04 13:05
#>                         optimal     manual      delta
#>   n_bins                      5          2         -3
...
p_missing
#> <scr_classing_proposal> P006 ds_optin | missing_to = 1 | 2026-09-04 13:05
#>                         optimal     manual      delta
#>   n_bins                      3          2         -1
...
lab
#> <scr_classing> target "default" | opened 2026-09-04 13:05 by analyst | 37 variables | 9 proposals: 2 accepted, 1 discarded
...
#> classing spec written to /tmp/Rtmp5xGqmv/classing_default.csv
```
...
#> <scr_classing_proposal> P010 vl_score_01 | breaks = c(42, 55, 70) | 2026-09-04 13:05
