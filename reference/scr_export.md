...
#>   /tmp/RtmpyQTubL/scorecraft-example/selection_default.xlsx
#>   /tmp/RtmpyQTubL/scorecraft-example/sql_woe_default.sql
#>   /tmp/RtmpyQTubL/scorecraft-example/summary_default.md
...
#>   /tmp/RtmpyQTubL/scorecraft-example/scorecard_default.xlsx
#>   /tmp/RtmpyQTubL/scorecraft-example/validation_default.xlsx
#>   /tmp/RtmpyQTubL/scorecraft-example/strategy_default.xlsx
#>   /tmp/RtmpyQTubL/scorecraft-example/sql_score_default.sql
#>   /tmp/RtmpyQTubL/scorecraft-example/sql_woe_default.sql
