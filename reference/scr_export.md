...
#>   /tmp/RtmpydbAKM/scorecraft-example/selection_default.xlsx
#>   /tmp/RtmpydbAKM/scorecraft-example/sql_woe_default.sql
#>   /tmp/RtmpydbAKM/scorecraft-example/summary_default.md
...
#>   /tmp/RtmpydbAKM/scorecraft-example/scorecard_default.xlsx
#>   /tmp/RtmpydbAKM/scorecraft-example/validation_default.xlsx
#>   /tmp/RtmpydbAKM/scorecraft-example/strategy_default.xlsx
#>   /tmp/RtmpydbAKM/scorecraft-example/sql_score_default.sql
#>   /tmp/RtmpydbAKM/scorecraft-example/sql_woe_default.sql
