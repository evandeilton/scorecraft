...
lab
#> <scr_classing> target "default" | opened 2026-09-04 23:09 by runner | 37 variables | 0 proposals: 0 accepted, 0 discarded
...
p <- scr_classing_propose(lab, "ds_regiao",
                          groups = list(south = c("BA", "RS"),
                                        north = c("SP", "RJ", "MG")))
p
#> <scr_classing_proposal> P001 ds_regiao | groups = list(south = c("BA", "RS"), north = c("SP", "RJ", "MG")) | 2026-09-04 23:09
...
lab
#> <scr_classing> target "default" | opened 2026-09-04 23:09 by runner | 37 variables | 1 proposals: 1 accepted, 0 discarded
