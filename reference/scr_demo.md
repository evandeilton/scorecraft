...
- `vl_constant`, `vl_near_const`, `ds_constant`, `vl_duplicate`,
  `vl_redundant`, `ds_high_card`:
...
Synthetic. Generated by `data-raw/scr_demo.R`, seed `20260903`, in the
package source repository <https://github.com/evandeilton/scorecraft>.
